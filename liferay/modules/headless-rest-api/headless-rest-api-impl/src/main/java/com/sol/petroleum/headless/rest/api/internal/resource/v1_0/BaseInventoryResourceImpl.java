...
public abstract class BaseInventoryResourceImpl implements InventoryResource {
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-rest-api/v1.0/inventory' -d $'{"action-name": ___, "inventoryArray": ___, "source-type": ___, "uuid": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Inventory")}
	)
	@javax.ws.rs.Consumes({"application/json", "application/xml"})
	@javax.ws.rs.Path("/inventory")
	@javax.ws.rs.POST
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseInventoryResourceImpl.class);
