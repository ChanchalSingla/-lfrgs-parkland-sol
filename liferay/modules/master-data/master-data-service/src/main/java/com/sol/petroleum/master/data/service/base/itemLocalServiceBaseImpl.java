 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sol.petroleum.master.data.service.impl.itemLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.sol.petroleum.master.data.service.impl.itemLocalServiceImpl
 * @generated
 */
public abstract class itemLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>itemLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>itemLocalServiceUtil</code>.
	 */
	...
	public item createitem(long masterDataItemId) {
		return itemPersistence.create(masterDataItemId);
	}
	...
	public item deleteitem(long masterDataItemId) throws PortalException {
		return itemPersistence.remove(masterDataItemId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return itemPersistence.dslQuery(dslQuery);
	}
	...
	public item fetchitem(long masterDataItemId) {
		return itemPersistence.fetchByPrimaryKey(masterDataItemId);
	}
	...
	public item getitem(long masterDataItemId) throws PortalException {
		return itemPersistence.findByPrimaryKey(masterDataItemId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setPrimaryKeyPropertyName("masterDataItemId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement itemLocalServiceImpl#deleteitem(item) to avoid orphaned data");
		}
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(itemLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		itemLocalService itemLocalService) {

		try {
			Field field = itemLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, itemLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		itemLocalServiceBaseImpl.class);
