...
public interface itemLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.sol.petroleum.master.data.service.impl.itemLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the item local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link itemLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public item addOrUpdtaeItemAudit(
	...
	public item createitem(long masterDataItemId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public item deleteitem(long masterDataItemId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public item fetchitem(long masterDataItemId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public item getitem(long masterDataItemId) throws PortalException;
